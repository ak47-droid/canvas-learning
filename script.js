...
loco()    //yaha pe locomotive aur scroll ka code pen wale code ko function mai daala hai taki code easy dekhe



//yeh page 2 ke text ko effects laane ke liye code ...

var clutter=""

document.querySelector('#page2>h1').textContent.split(" ").forEach(function(dets){
  clutter +=`<span> ${dets} </span>`                //yeh maine pehle galat kiya tha,isko hamesha space deke use karna hai...
...
gsap.to("#page2>h1>span",{
  scrollTrigger:{
    ...
    scroller:"#main",
    start:"top bottom",               //yaha pe top element ke liye hai aur bottom screen ke liye
    end:"bottom top",
    scrub:.5,
    //markers:true
  },
...
//page3 ka canvas ka code yaha se start ho raha hai
...
var data = `                                          //yaha pe toh hame images lagane hai
...
const frameCount = 67;                     //yaha pe changes hai
...
scrollTrigger: {
  scrub: .5,
  trigger: `#page3`,       //yaha pe changes hai
  start: `top top`,
  end: `250% top`,
  scroller: `#main`,
},
...
//yeh page 4 ke text ko effects laane ke liye code ...
...
//page7 ka circle ka code...

gsap.to(".page7-cir",{              //outer circle ke liye
  scrollTrigger:{
    trigger:".page7-cir",
    scroller:"#main",
    start:"top center",
...
gsap.to(".page7-inner-cir",{         //inner circle ke liye
  scrollTrigger:{
